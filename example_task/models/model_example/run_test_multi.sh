...
TEST_FILE_NAME="test_multi_0716_filtered_10labels.jsonl"
# ================== 可修改配置结束 ==================

# run_test_multi.sh 固定放在 tasks_id_x/models/model_name/ 下。
...
LOG_FILE="${MODEL_DIR}/test_multi_${RESULT_SUFFIX}.log"

[[ -f "${SINGLE_LABEL_CLASSIFICATION_DIR}/test_multi.py" ]] || { echo "测试代码不存在: ${SINGLE_LABEL_CLASSIFICATION_DIR}/test_multi.py" >&2; exit 1; }
